...
# Import the agent function you just made
from tactical_agent import ask_aegis_agent
...
def agent_command():
    ...
    try:
        # The agent will think, decide if it needs to call a tool, and return an answer
        ai_response = ask_aegis_agent(user_query)
